...
// 手前から1文字ずつ決めていけばi文字目を決めたときに増える転倒数の個数はわかる
// その後出来る文字列の転倒数の最小値最大値もわかる
// i文字目をcにしてその後の転倒数としてあり得る最大値がk以上ならcにしてしまって、そうでなければc+1を試す
// cの候補は既にsより大きいことが確定していたらa〜zでそうじゃなければs[i]〜z
